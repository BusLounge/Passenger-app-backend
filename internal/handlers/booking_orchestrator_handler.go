...
func (h *BookingOrchestratorHandler) AddLoungeToIntent(c *gin.Context) {
	...
	if req.PreTripLounge == nil && req.TransitLounge == nil && req.PostTripLounge == nil && req.ReturnPreTripLounge == nil && req.ReturnPostTripLounge == nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": "at least one lounge (pre_trip_lounge, transit_lounge, post_trip_lounge, return_pre_trip_lounge, or return_post_trip_lounge) must be provided"})
		return
	}
